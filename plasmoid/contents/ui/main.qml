...
PlasmoidItem {
    ...
    property string usbPdWatts: ""
    property string usbPdVolts: ""
    property string usbPdAmps: ""
    property string usbPdProtocol: ""
    property string dockName: ""
    property string dockAuthorized: ""
    property string thunderboltLink: ""
    property string usbPdRevision: ""
    property string usbPowerRole: ""
    ...
    toolTipSubText: {
        ...
        if (usbPdWatts) {
            parts.push("USB-C: " + usbPdVolts + " V · " + usbPdAmps + " A · " + usbPdWatts + " W");
        }
    ...
    fullRepresentation: PopupDialog {
        ...
        usbPdWatts: batterymonitor.usbPdWatts
        usbPdVolts: batterymonitor.usbPdVolts
        usbPdAmps: batterymonitor.usbPdAmps
        usbPdProtocol: batterymonitor.usbPdProtocol
        dockName: batterymonitor.dockName
        dockAuthorized: batterymonitor.dockAuthorized
        thunderboltLink: batterymonitor.thunderboltLink
        usbPdRevision: batterymonitor.usbPdRevision
        usbPowerRole: batterymonitor.usbPowerRole
    ...
    P5Support.DataSource {
        ...
        onNewData: function(sourceName, data) {
            ...
            if (!output) {
                batterymonitor.usbPdWatts = "";
                batterymonitor.usbPdVolts = "";
                batterymonitor.usbPdAmps = "";
                batterymonitor.usbPdProtocol = "";
                batterymonitor.dockName = "";
                return;
            }
            const fields = output.split("\t");
            batterymonitor.usbPdWatts = fields[1] || "";
            batterymonitor.usbPdVolts = fields[2] || "";
            batterymonitor.usbPdAmps = fields[3] || "";
            batterymonitor.usbPdProtocol = fields[4] || "";
            batterymonitor.dockName = fields[5] || "";
            batterymonitor.dockAuthorized = fields[6] || "";
            batterymonitor.thunderboltLink = fields[7] || "";
            batterymonitor.usbPdRevision = fields[8] || "";
            batterymonitor.usbPowerRole = fields[9] || "";
        }
    }
    ...
    Timer {
        ...
        onTriggered: usbPdSource.connectSource("/home/blackbox/.local/bin/read-usb-pd-status")
    }
