    ...
    contentItem: PlasmaComponents3.ScrollView {
        ...
        ListView {
            ...
            header: Column {
                ...
                UsbPdItem {
                    width: parent.width
                    visible: dialog.usbPdWatts.length > 0 || dialog.dockName.length > 0
                    watts: dialog.usbPdWatts
                    volts: dialog.usbPdVolts
                    amps: dialog.usbPdAmps
                    protocol: dialog.usbPdProtocol
                    dockName: dialog.dockName
                    dockAuthorized: dialog.dockAuthorized
                    thunderboltLink: dialog.thunderboltLink
                    pdRevision: dialog.usbPdRevision
                    powerRole: dialog.usbPowerRole
                }
            }
